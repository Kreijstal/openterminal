...
int main() {
    ...
    Check(IsRgb(red_pixel, 255, 0, 0), "initial root paints red through HWND");
    ...
    Check(IsRgb(blue_pixel, 0, 0, 255), "brush mutation repaints blue through HWND");
    ...
    Check(replay_one == blue_pixel && replay_two == blue_pixel,
    ...
    Check(!IsRgb(clear_pixel, 0, 255, 0),
    ...
    Check(IsRgb(PaintAndRead(second.window), 255, 0, 0),
