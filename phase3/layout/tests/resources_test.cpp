...
void ApplicationScope() {
    ...
    theme.Add("BoxWidth", ResourceValue{"x:Double", "80", ValueKind::Number, nullptr});
    theme.Add("ThemeWidth", ResourceValue{"x:Double", "44", ValueKind::Number, nullptr});
    theme.Add("ThemePad", ResourceValue{"Thickness", "1,2,3,4", ValueKind::Thickness, nullptr});
    theme.Add("ThemeFill", ResourceValue{"SolidColorBrush", "#FF1F1F1F", ValueKind::Brush, nullptr});
    theme.Add("ThemeInk", ResourceValue{"Color", "#FF1F1F1F", ValueKind::Color, nullptr});
